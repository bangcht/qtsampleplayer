...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_sampleplayer__renderer__QTGLRenderer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(0, 0, 36)
    ...
    "sampleplayer::renderer::QTGLRenderer\0"
};
...
const QMetaObject sampleplayer::renderer::QTGLRenderer::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_sampleplayer__renderer__QTGLRenderer.data,
      qt_meta_data_sampleplayer__renderer__QTGLRenderer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sampleplayer__renderer__QTGLRenderer.stringdata))
